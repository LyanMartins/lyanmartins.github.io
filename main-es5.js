...
var MapBoxComponent = /** @class */ (function () {
    function MapBoxComponent(mapService, homeComponent) {
    ...
    MapBoxComponent.prototype.buildMap = function () {
        ...
        this.map.on('click', function (event) {
            ...
            var newLocal = new _map__WEBPACK_IMPORTED_MODULE_2__["GeoJson"](coordinates, { message: _this.message });
            _this.markers.remove();
            _this.markers.setLngLat(coordinates).addTo(_this.map);
            //marker.setLngLat(coordinates).addTo(this.map);
            _this.flyTo(newLocal);
            var newLoction = _this.homeComponent.newLocalization(event.lngLat.lng, event.lngLat.lat);
            if (newLoction) {
                _this.homeComponent.allCuisine();
            }
        });
        this.map.on('load', function (event) {
            _this.map.addSource('local', {
                type: 'geojson',
                data: {
            ...
            _this.markers = new mapbox_gl__WEBPACK_IMPORTED_MODULE_3__["Marker"]().setLngLat([_this.lng, _this.lat]).addTo(_this.map);
        });
    };
    ...
    MapBoxComponent.ctorParameters = function () { return [
...
var GeoJson = /** @class */ (function () {
    ...
    GeoJson.ctorParameters = function () { return [
        null,
        null
    ]; };
    return GeoJson;
...
var FeatureCollection = /** @class */ (function () {
    ...
    FeatureCollection.ctorParameters = function () { return [
        { type: Array }
    ]; };
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.newLocalization = function (lng, lat) {
        try {
            this.lat = lat;
            this.log = lng;
            return true;
    ...
    HomeComponent.prototype.allCuisine = function () {
        var _this = this;
        this.cuisines = [];
        this.homeService.getCuisine(this.lat, this.log).subscribe(function (res) { return _this.cuisines = res; });
    };
    HomeComponent.prototype.findRestaurants = function () {
        var _this = this;
        this.homeService.getRestaurant(this.lat, this.log, this.ids).subscribe(function (res) { return _this.restaurants = res; });
    };
    HomeComponent.prototype.redirectTo = function (url) {
...
var HomeService = /** @class */ (function () {
    ...
    HomeService.prototype.getCuisine = function (lat, lng) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json' })
        };
        var path = 'dev/cuisine';
    ...
    HomeService.prototype.getRestaurant = function (lat, lng, ids) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json' })
        };
        var path = 'dev/restaurant';
        var queryString = '?lat=' + lat + '&lng=' + lng + '&cuisines=' + ids;
        return this.http.get(path + queryString, {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                'Content-Type': 'application/json',
                'Authorization': 'Bearer ' + localStorage['token'],
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(routes, loginService) {
        this.routes = routes;
    ...
    LoginComponent.prototype.Login = function () {
        var _this = this;
        console.log('entrou');
        var user = this.loginService.getUsers(this.login);
        if (user) {
            if (this.login == user.login && this.password == user.password) {
                console.log('aqui');
                this.loginService.getToken().subscribe(function (res) {
...
var LoginService = /** @class */ (function () {
    ...
    LoginService.prototype.getUsers = function (login) {
        var result = this.users.filter(function (user) { return user.login == login; });
        return result[0];
    };
